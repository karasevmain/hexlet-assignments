...
class FileKVTest {
    ...
    private static String pathString = "src/test/resources/file";
    ...
    @Test
    void inFileKVTest() {
        KeyValueStorage storage = new FileKV(pathString ,Map.of("key", "10"));
    ...
    void mustBeImmutableTest() {
        ...
        KeyValueStorage storage = new FileKV(pathString, initial);
